...
class ItemModel {
    ...
    public function __construct() {
        $this->dataSource = ItemArrayDao::getInstance(); //per recuperar una instancia 
     ...
     */
    public function searchItemById(int $id): ?Item {  //nullable return.Retorna null si no troba el item.
